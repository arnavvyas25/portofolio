...
import { siteMetadata, navItems } from '@/lib/data';
      ...
      <div className="container-custom py-12 md:py-16">
            ...
            <div className="flex gap-4">
              {siteMetadata.socialLinks.map((link) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg text-neutral-600 transition-colors hover:bg-neutral-200 hover:text-neutral-900"
        ...
        <div className="mt-12 border-t border-neutral-200 pt-8">
          <p className="text-center text-sm text-neutral-500">
            © {currentYear} Arnav Vyas. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
